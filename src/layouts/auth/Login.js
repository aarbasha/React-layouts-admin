                                    ...
                                    <div className="col-12 col-xl-4 order-xl-2">
                                        <div className="card-body p-4 p-sm-5">
                                            <div className='d-flex justify-content-between'>
                                                ...
                                                <div className="mb-5 spinner-border text-primary" role="status"> <span className="visually-hidden">Loading...</span>
                                                </div>
                                            </div>
                                                ...
                                                <div className="row g-3">
                                                    ...
                                                    <div className="col-12">
                                                        <div className="d-grid">
                                                            <button type="button" onClick={handelLogin} className="btn btn-primary radius-30 ">Login
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div className="col-12">
